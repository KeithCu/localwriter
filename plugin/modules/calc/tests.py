import ast
import json
from plugin.modules.calc.tools import execute_calc_tool, CALC_TOOLS
...
def run_calc_tests(ctx, model=None):
    ...
    try:
        ...
        try:
            from plugin.modules.core.document import get_calc_context_for_chat
...
def run_calc_integration_tests(ctx, model=None):
    ...
    try:
        from plugin.modules.core.config import get_api_config, validate_api_config
