...
from plugin.modules.core.document_tools import IMAGE_TOOLS
...
def execute_draw_tool(tool_name, arguments, model, ctx, status_callback=None):
    ...
    try:
        if tool_name == "list_pages":
            ...
            from plugin.modules.core.document_tools import tool_generate_image
            return tool_generate_image(model, ctx, arguments, status_callback=status_callback)

        elif tool_name == "edit_image":
            # Delegate to existing implementation
            from plugin.modules.core.document_tools import tool_edit_image
