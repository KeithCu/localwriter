...
def pytest_ignore_collect(collection_path, config):
    ...
    if name in ("test_calc.py", "test_chat_model_logic.py", "test_draw.py", "test_writer.py", "test_document.py", "test_linebreak_conversion.py", "test_writer_navigation.py", "test_constants.py", "test_impress.py", "test_writer_bookmarks.py", "test_writer_search.py"):
        try:
