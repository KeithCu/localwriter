...
| Peer messaging | [chat/peer-messaging.md](chat/peer-messaging.md) — Writer ↔ Calc ↔ Draw async `send_peer_message` (A1 on master; specialized-inner experiment: document_research only) |
