...
to **50** (AFC / Tenant / Cadaver / Draw-primary) or **150** (GMP Change
Control) and restores when done. Everyday default stays **15**. Schema
...
Stubs **5–7 and 9–10 are not wired** into `--task` / `--launch` /
