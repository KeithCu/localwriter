...
| Compaction | UNO-free history compact (PR1 module; tool-loop wire is later) | [`plugin/chatbot/compaction.py`](../plugin/chatbot/compaction.py) — [chat/compaction-dev-plan.md](chat/compaction-dev-plan.md) |
