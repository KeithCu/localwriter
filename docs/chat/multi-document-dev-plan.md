...
- [peer-messaging.md](peer-messaging.md) — Writer ↔ Calc ↔ Draw peer-ask (writes in a peer-context loop; research stays read-only)
...
| ---- | -------------- | ---------- |
| 2026-09-08 | Peer-ask design (separate feature): Writer ↔ Calc ↔ Draw via `ask_peer_agent`; research stays read-only — [peer-messaging.md](peer-messaging.md) | — |
